...
var GenericIcon = ({ className, path, height = 24, color = "currentColor" }) => /* @__PURE__ */ import_react.default.createElement("svg", {
  className,
  viewBox: "0 0 24 24",
  height,
  fill: color
...
var Close = ({ height = 24, color = "currentColor" }) => /* @__PURE__ */ import_react.default.createElement("svg", {
  viewBox: "0 0 24 24",
  height,
  fill: color
}, /* @__PURE__ */ import_react.default.createElement("path", {
...
var ThemedButton = import_react2.default.forwardRef((_a, ref) => {
  var _b = _a, { children } = _b, rest = __objRest(_b, ["children"]);
  return /* @__PURE__ */ import_react2.default.createElement(import_theme_ui.Button, __spreadProps(__spreadValues({}, rest), {
    ref
  }), children);
});
ThemedButton.displayName = "Button";
var StyledThemedButton = (0, import_styled.default)(ThemedButton)`
  appearance: none;
  cursor: pointer;
  position: relative;
  user-select: none;
...
var InputSearch = (0, import_react3.forwardRef)((_a, ref) => {
  ...
  return /* @__PURE__ */ import_react3.default.createElement(import_theme_ui2.Box, {
...
var StyledInputSearch = (0, import_styled2.default)(InputSearch)`
  & > * {
    grid-column: 1;
    grid-row: 1;
  }
...
var Select = (_a) => {
  ...
  return /* @__PURE__ */ import_react4.default.createElement("select", __spreadValues({}, rest), placeholder && /* @__PURE__ */ import_react4.default.createElement("option", {
    value: ""
  }, placeholder), children);
};
var StyledSelect = (0, import_styled3.default)(Select)`
  -moz-appearance: none;
  ...
  ${(props) => props.maxWidth && import_react5.css`max-width: ${props.maxWidth};`}
  ${(props) => props.width && import_react5.css`width: ${props.width};`}
  ...
  ${(props) => {
  var _a, _b;
  return props.invalid && import_react5.css`border-color: ${((_b = (_a = props == null ? void 0 : props.theme) == null ? void 0 : _a.colors) == null ? void 0 : _b.danger) || "red"} !important;`;
}}
  &:focus {
...
var OptimisticCheckbox = import_react6.default.forwardRef(({ checked = false, onChange, className }, ref) => {
  const [checkedState, setCheckedState] = import_react6.default.useState(false);
...
var StyledOptimisticCheckbox = (0, import_styled4.default)(OptimisticCheckbox)`
